...
<head>
    ...
    <style>
        ...
        body {
            background: url("<?= base_url()?>___/img/img1.jpg") !important;
    ...
    <div class="col-md-4">
        <form action="" method="post" name="fl" id="f_login" onsubmit="return login();">
            ...
            <div class="panel panel-default top150">
                <div class="panel-heading"><h4 style="margin: 5px"><i class="glyphicon glyphicon-user"></i> Computer
                        Assisted Test</h4>
                </div>
                <div class="panel-body">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="username" name="username" autofocus value="" placeholder="Username"
                               class="form-control"/>
                    </div> <!-- /field -->
